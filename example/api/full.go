...
type BasicAPI interface {
	...
	//GetInt(ctx context.Context) (p1 int, p2 int8, p3 int16, p4 int32, p5 int64, err error)
	//GetUint(ctx context.Context) (p1 uint, p2 uint8, p3 uint16, p4 uint32, p5 uint64, err error)
	//GetString(ctx context.Context) (p1 string, err error)
	//GetFloat(ctx context.Context) (p1 float32, p2 float64, err error)
